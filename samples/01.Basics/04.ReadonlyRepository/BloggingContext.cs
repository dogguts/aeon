...
namespace Aeon.Samples.Basics.ReadonlyRepositoryExample.Models {
    public class BloggingContext : DbContext {
        public DbSet<Blog> Blogs { get; set; }
        public DbSet<Post> Posts { get; set; }

        public DbQuery<PostCountByBlogs> PostCountByBlogs { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Query<PostCountByBlogs>().ToView("PostCountByBlogs");
