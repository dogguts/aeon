...
using Aeon.Samples.Basics.ReadonlyRepositoryExample.Models;
using System.Linq;

namespace Aeon.Samples.Basics.ReadonlyRepositoryExample {
    ...
    class Program {
        ...
        static void Main() {
            ...
            dbContext.Database.ExecuteSqlCommand  ("DROP VIEW IF EXISTS PostCountByBlogs;");
